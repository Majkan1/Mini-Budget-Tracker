...
function Title() {
  return (
    <div className='Title'>
      <h4 style={{ marginBottom: "5px" }}>Budget Tracker</h4>
      <p style={{ fontSize: "10px", color: "gray", marginTop: "5px" }}>Track your income & expenses</p>
    </div>
  );
}
...
function List(props: { transactions: Transaction[] }) {
  ...
  return (
    <div style={{ marginTop: '15px', width: '320px' }}>
      <h5 style={{ margin: '10px 0', color: '#333' }}>Recent Transactions</h5>
